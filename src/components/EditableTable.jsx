        ...
        <Tbody>
          {data.map((row, rowIndex) => (
            <Tr key={rowIndex}>
              ...
              <Td>
                <IconButton icon={<FaTrash />} colorScheme="red" onClick={() => handleRemoveRow(rowIndex)} />
              </Td>
            </Tr>
          ))}
        </Tbody>
      </Table>
      <Button leftIcon={<FaPlus />} colorScheme="green" onClick={handleAddRow} mt={4}>Add Row</Button>
    </>
  );
};
